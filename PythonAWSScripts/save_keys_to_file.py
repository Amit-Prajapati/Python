#Function of this program: A python program that will allow you to filter by a set of prefixes, suffixes, and/or last modified date.
#How to run: python save_keys_to_file.py -b 'bucket_name' -p some/prefix -s '.txt' '.TXT' -f '/Path/To/Some/File/test_keys.txt' -n '2018-1-1' -x '2018-2-1'
#Note: This supports prefixes that contain more than 1000 keys.
